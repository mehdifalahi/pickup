...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        // Templates
        'infowindowTemplatePath'     : 'views/js/plugins/storeLocator/templates/infowindow-description.html',
        'listTemplatePath'           : 'views/js/plugins/storeLocator/templates/location-list-description.html',
        'KMLinfowindowTemplatePath'  : 'views/js/plugins/storeLocator/templates/kml-infowindow-description.html',
        'KMLlistTemplatePath'        : 'views/js/plugins/storeLocator/templates/kml-location-list-description.html',
        'listTemplateID'             : null,
	...
	$.extend(Plugin.prototype, {
		...
		taxonomyFiltering: function() {
			...
			// faddons
			$('#maxdistance').on('change',function(e){
				var maxdis = $(this).val();
				if(maxdis){
					_this.settings.maxDistance = true;
				} else {
					_this.settings.maxDistance = false;
				}
				//_this.reset();				
				_this.processForm();
			});
